  ...
  return (
    <section className="relative w-full h-screen mx-auto">
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            ...
            <span className="animate-text bg-gradient-to-r from-teal-500 via-purple-500 to-orange-500 bg-clip-text text-transparent font-black">
              Raja <span className="hidden sm:inline">Madan</span>
            </span>
          </h1>
      ...
      <div className="absolute right-5 top-1/2 -translate-y-1/2 flex flex-col gap-5 items-center md:mt-10 mt-5 md:gap-12">
        <Link target="_blank" to="https://www.linkedin.com/in/rajamadan/">
          <BsLinkedin
            size={30}
        ...
        <Link target="_blank" to="https://github.com/Rajamadan">
          <BsGithub
            size={30}
        ...
        <Link target="_blank" to="https://discord.com/channels/@me/798102116894769193">
          <BsDiscord
            size={30}
        ...
        <Link target="_blank" to="https://www.instagram.com/raja_madan__/">
          <BsInstagram
            size={30}
