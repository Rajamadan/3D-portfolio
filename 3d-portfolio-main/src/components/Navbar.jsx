...
import resume from "../src/rajamadan_cv.pdf"; // Ensure correct path based on your folder structure
      ...
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex">
            Game Developer | Flutter App Developer | 3D Designer &nbsp;
          </p>
        </Link>

        <ul className="list-none hidden sm:flex flex-row items-center gap-10">
          <a href={resume} download="rajamadan_cv.pdf">
            <button
              className={`${
                active === "Download CV" ? "abhishek" : "abhishek-btn"
